...
## Method: ✓ DoGetGroupsUsers [Medium]

---

---
## TASK: Implement Hardcoded DoGetGroupsUsers Method
---

### Objective Implement a hardcoded/mock version of the DoGetGroupsUsers method for the iCustomConnector2 interface.
...
### Documentation Files
• @doc/per-interface-method/DoGetGroupsUsers.json - Example request/response data (USE THIS AS YOUR TEMPLATE)
• @doc/per-interface-method/DoGetGroupsUsers-request.md - Request structure
• @doc/per-interface-method/DoGetGroupsUsers-response.md - Response structure
• @iCustomConnector2impl/Models/ICustomConnectorInterfaces.cs - Interface definition and types
• @doc/per-interface-method/DoGetGroupsUsers-hardcode.cs - EXISTING HARDCODE IMPLEMENTATION (copy/adapt this!)

### Files to Create in /iCustomConnector2impl/Methods/DoGetGroupsUsers/:
...
### Testing
1. Run: `./scripts/unit_test.py --class AiGeneratedConnector.Methods.DoGetGroupsUsers`
...
Write a report to `./reports/DoGetGroupsUsers_hardcode.txt` that includes:
